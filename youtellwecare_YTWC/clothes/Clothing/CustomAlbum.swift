...
//    static let shared = CustomAlbum()
    ...
    func checkAuthorizationWithHandler(completion: @escaping (Result<Bool>) -> ()) {
    ...
    private func createAlbumIfNeeded(completion: @escaping (Result<Bool>) -> ()) {
        if let assetCollection = fetchAssetCollectionForAlbum() {
    ...
    func save(image: UIImage, completion: @escaping (Result<Bool>) -> ()) {
